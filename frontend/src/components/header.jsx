...
const MENU = [
  ...
  },
  {
    ...
    icon: ChartBarIcon,
    children: [
      { name: "Laporan Cabang", children: [
        {name: "Detail Transaksi", link: "/branch-reports/transaction-details"},
        {name: "Manifest Outbound", link: "/branch-reports/manifest-outbound"},
        {name: "Pengantaran", link: "/branch-reports/delivery"},
        {name: "Gross Profit", link: "/branch-reports/gross-profit"},
        {name: "Rekap Gross Profit", link: "/branch-reports/rekap-gross-profit"},
        {name: "Manifest Vendor", link: "/branch-reports/manifest-vendor"}, 
        {name: "AWB", link: "/branch-reports/awb" },
        {name: "Rekap Customer BUlanan", link: "/branch-reports/customer-monthly-summary" },
        {name: "Rekap Omset Harian", link: "/branch-reports/daily-turnover-summary" },
        {name: "Detail Transaksi Inbound", link: "/branch-reports/inbound-transaction-details" },       
      ] },
