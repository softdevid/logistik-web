...
type Marketing struct {
	...
	Branch   *BranchRef `gorm:"foreignKey:BranchID" json:"branch,omitempty"`
	Status   string     `gorm:"size:10;not null;default:Active" json:"status"`
}
...
type DeliveryService struct {
	...
	Moda              *Mode            `gorm:"foreignKey:ModaID" json:"moda,omitempty"`
	Status            string           `gorm:"size:10;not null;default:Active" json:"status"`
}
...
func (BranchRef) TableName() string { return "branches" }

type Vehicle struct {
	ID               uint          `gorm:"primaryKey" json:"id"`
	Name             string        `gorm:"size:100;not null;column:name" json:"name"`
	JenisTruckingID  *uint         `gorm:"index;column:jenis_trucking_id" json:"jenis_trucking_id"`
	JenisTrucking    *TruckingType `gorm:"foreignKey:JenisTruckingID" json:"jenis_trucking,omitempty"`
